...
SAUCE_CONNECT_BIN = os.getenv('SAUCE_CONNECT_BIN')
SAUCE_TUNNEL_ID = os.getenv('SAUCE_TUNNEL_ID')
SAUCE_SERVER_URL = os.getenv('SAUCE_SERVER_URL')
APP_APK_URL = os.getenv('APP_APK_URL')
...
def appium_driver():
  ...
  driver = webdriver.Remote(
    command_executor=SAUCE_SERVER_URL,
    options=options
  )
