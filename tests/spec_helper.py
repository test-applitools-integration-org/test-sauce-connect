...
class SauceTunnel:
    ...
    def __init__(self, username: str, access_key: str, sc_path: str, tunnel_name: str, 
                 dns: bool, no_ssl_bump_domains: bool, proxy: str):
    ...
    def wait_for_sc_readiness(self, timeout_seconds: int = 300) -> bool:
        ...
        while True:
            ...
            if time_elapsed > timeout_seconds:
                raise TimeoutError(f"Service readiness check timed out after {timeout_seconds} seconds")
            ...
            print(f"Retrying in {sleep_time} seconds... ({int(remaining_time)}s remaining)")
        ...
        for attempt in range(self.MAX_RETRIES):
            try:
                ...
                if self.no_ssl_bump_domains:
                    sc_command.extend(['--no-ssl-bump-domains', self.no_ssl_bump_domains])
